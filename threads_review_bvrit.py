...
Original file is located at
    https://colab.research.google.com/drive/1pKtOl_A7Y4wrR7BZCi7M0fqENTCgPBic
...
def tokenization(text):
    tokens = re.split(' ',text)#if non alphanumeric is there then it will split(W+)
    return tokens
...
import nltk
nltk.download('stopwords')# words which dont contribute to analysis
